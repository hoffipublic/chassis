...
abstract class AKotlinProperty(val property: Property, val modelClassDataFromDsl: ModelClassDataFromDsl) {
    val log = LoggerFactory.getLogger(javaClass)
    abstract val builder: PropertySpec.Builder
    override fun toString(): String = "Property(${property.name()}) of ${modelClassDataFromDsl}\n${builder.build().toString()}"
